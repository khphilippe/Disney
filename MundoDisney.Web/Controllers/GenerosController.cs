...
namespace MundoDisney.Web.Controllers
{
    public class GenerosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GeneroId,Nombre,ImageId")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GeneroId,Nombre,ImageId")] Genero genero)
        {
